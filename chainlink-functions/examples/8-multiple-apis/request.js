...
const consumerAddress = "0x3f32609d4dbcdc00139fb67b7cb96322f6369216"; // REPLACE this with your Functions consumer address
const subscriptionId = 595; // REPLACE this with your subscription ID
...
const makeRequestMumbai = async () => {
  ...
  const transaction = await functionsConsumer.sendRequest(
    ...
    0, // slot ID of the encrypted secrets
